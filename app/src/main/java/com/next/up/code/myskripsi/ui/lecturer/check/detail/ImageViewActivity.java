...
public class ImageViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String fileName = getIntent().getStringExtra("pathImage");
        ...
        webView.loadUrl("https://mobileapi12.000webhostapp.com/uploads/" + fileName);
    ...
    private class Callback extends WebViewClient {
        ...
        public void onReceivedError(WebView view, int errorCode, String description, String failingUrl) {
            new AestheticDialog.Builder(ImageViewActivity.this, DialogStyle.EMOTION, DialogType.ERROR)
                    .setTitle("Kesalahan")
